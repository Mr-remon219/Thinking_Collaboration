...
public class FuzerenController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		FuzerenEntity u = fuzerenService.selectOne(new EntityWrapper<FuzerenEntity>().eq("tuanduimingcheng", username));
    ...
    public R register(@RequestBody FuzerenEntity fuzeren){
    	...
    	FuzerenEntity u = fuzerenService.selectOne(new EntityWrapper<FuzerenEntity>().eq("tuanduimingcheng", fuzeren.getTuanduimingcheng()));
		if(u!=null) {
    ...
    public R save(@RequestBody FuzerenEntity fuzeren, HttpServletRequest request){
        if(fuzerenService.selectCount(new EntityWrapper<FuzerenEntity>().eq("tuanduimingcheng", fuzeren.getTuanduimingcheng()))>0) {
    ...
    public R update(@RequestBody FuzerenEntity fuzeren, HttpServletRequest request){
        //ValidatorUtils.validateEntity(fuzeren);
        if(fuzerenService.selectCount(new EntityWrapper<FuzerenEntity>().ne("id", fuzeren.getId()).eq("tuanduimingcheng", fuzeren.getTuanduimingcheng()))>0) {
            return R.error("团队名称已存在");
        }
